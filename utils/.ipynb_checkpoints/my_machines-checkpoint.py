...
def my_machine_with_detuners(Qx_init, Qy_init, k3_equivalent_x, k3_equivalent_y, turn, bunch, twiss, flag_detuner, flag_noise, flag_BB, flag_feedback, max_aperture_value, Delta = 0., ksi = 0., gain = 0., sigmax = 0., sigmapx = 0., sigmay=0., sigmapy = 0.):
    if turn == 1:
